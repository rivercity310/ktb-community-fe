    ...
    <div className="bg-gray-100 dark:bg-[#121212] text-black dark:text-gray-300 overflow-x-hidden h-screen w-screen">
      ...
      {!isAuthenticated && (
        <div>
          ...
          <div
            className="
          glass blur-2xl fixed w-[calc(100%-16px)] h-1/3 opacity-95 bottom-0 right-0 left-0
          bg-gradient-to-br from-gray-200 via-gray-400 to-orange-100 pointer-events-none
        "
            aria-hidden="true"
          />
          {/* 로그인 메시지와 버튼 */}
          <div className="fixed bottom-[15%] flex flex-col justify-center items-center gap-4 right-0 left-0 pointer-events-none">
            <p className="font-bold text-2xl z-10">
              로그인하고 다양한 서비스를 만나보세요.
            </p>
            <Button
